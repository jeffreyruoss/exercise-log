 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bn=new To("@firebase/app"),oy="@firebase/app-compat",ay="@firebase/analytics-compat",cy="@firebase/analytics",uy="@firebase/app-check-compat",ly="@firebase/app-check",hy="@firebase/auth",dy="@firebase/auth-compat",fy="@firebase/database",my="@firebase/database-compat",py="@firebase/functions",gy="@firebase/functions-compat",_y="@firebase/installations",yy="@firebase/installations-compat",Iy="@firebase/messaging",vy="@firebase/messaging-compat",Ey="@firebase/performance",wy="@firebase/performance-compat",Ty="@firebase/remote-config",Ay="@firebase/remote-config-compat",Ry="@firebase/storage",by="@firebase/storage-compat",Py="@firebase/firestore",Sy="@firebase/firestore-compat",Cy="firebase",ky="10.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fy="firebase-heartbeat-database",Uy=1,vi="firebase-heartbeat-store";let Ea=null;function Wd(){return Ea||(Ea=ty(Fy,Uy,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(vi)}}}).catch(n=>{throw yt.create("idb-open",{originalErrorMessage:n.message})})),Ea}async function By(n){try{return await(await Wd()).transaction(vi).objectStore(vi).get(Hd(n))}catch(e){if(e instanceof Ve)bn.warn(e.message);else{const t=yt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});bn.warn(t.message)}}}async function Ul(n,e){try{const r=(await Wd()).transaction(vi,"readwrite");await r.objectStore(vi).put(e,Hd(n)),await r.done}catch(t){if(t instanceof Ve)bn.warn(t.message);else{const r=yt.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});bn.warn(r.message)}}}function Hd(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hy{constructor(e,t){this._delegate=e,this.firebase=t,Qs(e,new ht("app-compat",()=>this,"PUBLIC")),this.container=e.container}get automaticDataCollectionEnabled(){return this._delegate.automaticDataCollectionEnabled}set automaticDataCollectionEnabled(e){this._delegate.automaticDataCollectionEnabled=e}get name(){return this._delegate.name}get options(){return this._delegate.options}delete(){return new Promise(e=>{this._delegate.checkDestroyed(),e()}).then(()=>(this.firebase.INTERNAL.removeApp(this.name),jd(this._delegate)))}_getService(e,t=Bt){var r;this._delegate.checkDestroyed();const i=this._delegate.container.getProvider(e);return!i.isInitialized()&&((r=i.getComponent())===null||r===void 0?void 0:r.instantiationMode)==="EXPLICIT"&&i.initialize(),i.getImmediate({identifier:t})}_removeServiceInstance(e,t=Bt){this._delegate.container.getProvider(e).clearInstance(t)}_addComponent(e){Qs(this._delegate,e)}_addOrOverwriteComponent(e){$d(this._delegate,e)}toJSON(){return{name:this.name,automaticDataCollectionEnabled:this.automaticDataCollectionEnabled,options:this.options}}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yy(n){const e={},t={__esModule:!0,initializeApp:s,app:i,registerVersion:ut,setLogLevel:Kd,onLog:zd,apps:null,SDK_VERSION:Zt,INTERNAL:{registerComponent:a,removeApp:r,useAsService:c,modularAPIs:Wy}};t.default=t,Object.defineProperty(t,"apps",{get:o});function r(u){delete e[u]}function i(u){if(u=u||Bt,!Nl(e,u))throw $l.create("no-app",{appName:u});return e[u]}i.App=n;function s(u,l={}){const h=Gc(u,l);if(Nl(e,h.name))return e[h.name];const d=new n(h,t);return e[h.name]=d,d}function o(){return Object.keys(e).map(u=>e[u])}function a(u){const l=u.name,h=l.replace("-compat","");if($t(u)&&u.type==="PUBLIC"){const d=(f=i())=>{if(typeof f[h]!="function")throw $l.create("invalid-app-argument",{appName:l});return f[h]()};u.serviceProps!==void 0&&Hs(d,u.serviceProps),t[h]=d,n.prototype[h]=function(...f){return this._getService.bind(this,l).apply(this,u.multipleInstances?f:[])}}return u.type==="PUBLIC"?t[h]:null}function c(u,l){return l==="serverAuth"?null:l}return t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qd(){const n=Yy(Hy);n.INTERNAL=Object.assign(Object.assign({},n.INTERNAL),{createFirebaseNamespace:Qd,extendNamespace:e,createSubscribe:Fd,ErrorFactory:Un,deepExtend:Hs});function e(t){Hs(n,t)}return n}const Jy=Qd();/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gl=new To("@firebase/app-compat"),Xy="@firebase/app-compat",Zy="0.2.15";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ys=new To("@firebase/auth");function oI(n,...e){Ys.logLevel<=L.WARN&&Ys.warn(`Auth (${Zt}): ${n}`,...e)}function Os(n,...e){Ys.logLevel<=L.ERROR&&Ys.error(`Auth (${Zt}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ci(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function pI(n,e=!1){const t=S(n),r=await t.getIdToken(e),i=Ao(r);y(i&&i.exp&&i.auth_time&&i.iat,t.auth,"internal-error");const s=typeof i.firebase=="object"?i.firebase:void 0,o=s==null?void 0:s.sign_in_provider;return{claims:i,token:r,authTime:ci(wa(i.auth_time)),issuedAtTime:ci(wa(i.iat)),expirationTime:ci(wa(i.exp)),signInProvider:o||null,signInSecondFactor:(s==null?void 0:s.sign_in_second_factor)||null}}function wa(n){return Number(n)*1e3}function Ao(n){const[e,t,r]=n.split(".");if(e===void 0||t===void 0||r===void 0)return Os("JWT malformed, contained fewer than 3 sections"),null;try{const i=xd(t);return i?JSON.parse(i):(Os("Failed to decode base64 JWT payload"),null)}catch(i){return Os("Caught error parsing JWT payload as JSON",i==null?void 0:i.toString()),null}}function gI(n){const e=Ao(n);return y(e,"internal-error"),y(typeof e.exp<"u","internal-error"),y(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function PI(n){return(await he(n,"GET","/v1/recaptchaParams")).recaptchaSiteKey||""}async function df(n,e){return he(n,"GET","/v2/recaptchaConfig",ce(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _f(n,e){return he(n,"POST","/v1/accounts:resetPassword",ce(n,e))}async function yf(n,e){return he(n,"POST","/v1/accounts:update",e)}async function FI(n,e){return he(n,"POST","/v1/accounts:update",ce(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ta(n,e){return At(n,"POST","/v1/accounts:signInWithPassword",ce(n,e))}async function Ro(n,e){return he(n,"POST","/v1/accounts:sendOobCode",ce(n,e))}async function UI(n,e){return Ro(n,e)}async function Aa(n,e){return Ro(n,e)}async function Ra(n,e){return Ro(n,e)}async function BI(n,e){return Ro(n,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qI(n,e){return At(n,"POST","/v1/accounts:signInWithEmailLink",ce(n,e))}async function $I(n,e){return At(n,"POST","/v1/accounts:signInWithEmailLink",ce(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function It(n,e){return At(n,"POST","/v1/accounts:signInWithIdp",ce(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function QI(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function YI(n){const e=nr(ei(n)).link,t=e?nr(ei(e)).deep_link_id:null,r=nr(ei(n)).deep_link_id;return(r?nr(ei(r)).link:null)||r||t||e||n}class bo{constructor(e){var t,r,i,s,o,a;const c=nr(ei(e)),u=(t=c.apiKey)!==null&&t!==void 0?t:null,l=(r=c.oobCode)!==null&&r!==void 0?r:null,h=QI((i=c.mode)!==null&&i!==void 0?i:null);y(u&&l&&h,"argument-error"),this.apiKey=u,this.operation=h,this.code=l,this.continueUrl=(s=c.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(o=c.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=c.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const t=YI(e);try{return new bo(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class en{constructor(){this.providerId=en.PROVIDER_ID}static credential(e,t){return Ai._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=bo.parseLink(t);return y(r,"argument-error"),Ai._fromEmailAndCode(e,r.code,r.tenantId)}}en.PROVIDER_ID="password";en.EMAIL_PASSWORD_SIGN_IN_METHOD="password";en.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const XI="saml.";class Js extends Rt{constructor(e){y(e.startsWith(XI),"argument-error"),super(e)}static credentialFromResult(e){return Js.samlCredentialFromTaggedObject(e)}static credentialFromError(e){return Js.samlCredentialFromTaggedObject(e.customData||{})}static credentialFromJSON(e){const t=fr.fromJSON(e);return y(t,"argument-error"),t}static samlCredentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{pendingToken:t,providerId:r}=e;if(!t||!r)return null;try{return fr._create(r,t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ms(n,e){return At(n,"POST","/v1/accounts:signUp",ce(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ev(n,e){const t=S(n);await Po(!0,t,e);const{providerUserInfo:r}=await fI(t.auth,{idToken:await t.getIdToken(),deleteProvider:[e]}),i=vf(r||[]);return t.providerData=t.providerData.filter(s=>i.has(s.providerId)),i.has("phone")||(t.phoneNumber=null),await t.auth._persistUserIfCurrent(t),t}async function Yc(n,e,t=!1){const r=await vt(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return He._forOperation(n,"link",r)}async function Po(n,e,t){await wi(e);const r=vf(e.providerData),i=n===!1?"provider-already-linked":"no-such-provider";y(r.has(t)===n,e.auth,i)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wf(n,e,t=!1){const r="signIn",i=await If(n,r,e),s=await He._fromIdTokenResponse(n,r,i);return t||await n._updateCurrentUser(s.user),s}async function So(n,e){return wf(se(n),e)}async function Tf(n,e){const t=S(n);return await Po(!1,t,e.providerId),Yc(t,e)}async function Af(n,e){return Ef(S(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tv(n,e){return At(n,"POST","/v1/accounts:signInWithCustomToken",ce(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function uv(n,e,t){var r;const i=se(n),s={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function o(a,c){y(c.handleCodeInApp,i,"argument-error"),c&&or(i,a,c)}if(!((r=i._getRecaptchaConfig())===null||r===void 0)&&r.emailPasswordEnabled){const a=await Gt(i,s,"getOobCode",!0);o(a,t),await Ra(i,a)}else o(s,t),await Ra(i,s).catch(async a=>{if(a.code==="auth/missing-recaptcha-token"){console.log("Email link sign-in is protected by reCAPTCHA for this project. Automatically triggering the reCAPTCHA flow and restarting the sign-in flow.");const c=await Gt(i,s,"getOobCode",!0);o(c,t),await Ra(i,c)}else return Promise.reject(a)})}function lv(n,e){const t=bo.parseLink(e);return(t==null?void 0:t.operation)==="EMAIL_SIGNIN"}async function hv(n,e,t){const r=S(n),i=en.credentialWithLink(e,t||Ei());return y(i._tenantId===(r.tenantId||null),r,"tenant-id-mismatch"),So(r,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function dv(n,e){return he(n,"POST","/v1/accounts:createAuthUri",ce(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pv(n,e){return he(n,"POST","/v2/accounts/mfaEnrollment:start",ce(n,e))}function Sv(n,e){return he(n,"POST","/v2/accounts/mfaEnrollment:finalize",ce(n,e))}function Cv(n,e){return he(n,"POST","/v2/accounts/mfaEnrollment:withdraw",ce(n,e))}class eu{constructor(e){this.user=e,this.enrolledFactors=[],e._onReload(t=>{t.mfaInfo&&(this.enrolledFactors=t.mfaInfo.map(r=>Qi._fromServerResponse(e.auth,r)))})}static _fromUser(e){return new eu(e)}async getSession(){return gn._fromIdtoken(await this.user.getIdToken(),this.user)}async enroll(e,t){const r=e,i=await this.getSession(),s=await vt(this.user,r._process(this.user.auth,i,t));return await this.user._updateTokensIfNecessary(s),this.user.reload()}async unenroll(e){const t=typeof e=="string"?e:e.uid,r=await this.user.getIdToken();try{const i=await vt(this.user,Cv(this.user.auth,{idToken:r,mfaEnrollmentId:t}));this.enrolledFactors=this.enrolledFactors.filter(({uid:s})=>s!==t),await this.user._updateTokensIfNecessary(i),await this.user.reload()}catch(i){throw i}}}const ba=new WeakMap;function kv(n){const e=S(n);return ba.has(e)||ba.set(e,eu._fromUser(e)),ba.get(e)}const Zs="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sf{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(Zs,"1"),this.storage.removeItem(Zs),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zv(n,e){return he(n,"POST","/v2/accounts/mfaSignIn:start",ce(n,e))}function Kv(n,e){return he(n,"POST","/v2/accounts/mfaSignIn:finalize",ce(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pa=mf("rcb"),Xv=new Wi(3e4,6e4),Zv="https://www.google.com/recaptcha/api.js?";class eE{constructor(){var e;this.hostLanguage="",this.counter=0,this.librarySeparatelyLoaded=!!(!((e=ae().grecaptcha)===null||e===void 0)&&e.render)}load(e,t=""){return y(tE(t),e,"argument-error"),this.shouldResolveImmediately(t)&&Wl(ae().grecaptcha)?Promise.resolve(ae().grecaptcha):new Promise((r,i)=>{const s=ae().setTimeout(()=>{i(Te(e,"network-request-failed"))},Xv.get());ae()[Pa]=()=>{ae().clearTimeout(s),delete ae()[Pa];const a=ae().grecaptcha;if(!a||!Wl(a)){i(Te(e,"internal-error"));return}const c=a.render;a.render=(u,l)=>{const h=c(u,l);return this.counter++,h},this.hostLanguage=t,r(a)};const o=`${Zv}?${Pr({onload:Pa,render:"explicit",hl:t})}`;Qc(o).catch(()=>{clearTimeout(s),i(Te(e,"internal-error"))})})}clearedOneInstance(){this.counter--}shouldResolveImmediately(e){var t;return!!(!((t=ae().grecaptcha)===null||t===void 0)&&t.render)&&(e===this.hostLanguage||this.counter>0||this.librarySeparatelyLoaded)}}function tE(n){return n.length<=6&&/^\s*[a-zA-Z0-9\-]*\s*$/.test(n)}class nE{async load(e){return new Qv(e)}clearedOneInstance(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ru{constructor(e,t){this.verificationId=e,this.onConfirmation=t}confirm(e){const t=Tn._fromVerification(this.verificationId,e);return this.onConfirmation(t)}}async function oE(n,e,t){const r=se(n),i=await Do(r,e,S(t));return new ru(i,s=>So(r,s))}async function aE(n,e,t){const r=S(n);await Po(!1,r,"phone");const i=await Do(r.auth,e,S(t));return new ru(i,s=>Tf(r,s))}async function cE(n,e,t){const r=S(n),i=await Do(r.auth,e,S(t));return new ru(i,s=>Af(r,s))}async function Do(n,e,t){var r;const i=await t.verify();try{y(typeof i=="string",n,"argument-error"),y(t.type===xf,n,"argument-error");let s;if(typeof e=="string"?s={phoneNumber:e}:s=e,"session"in s){const o=s.session;if("phoneNumber"in s)return y(o.type==="enroll",n,"internal-error"),(await Pv(n,{idToken:o.credential,phoneEnrollmentInfo:{phoneNumber:s.phoneNumber,recaptchaToken:i}})).phoneSessionInfo.sessionInfo;{y(o.type==="signin",n,"internal-error");const a=((r=s.multiFactorHint)===null||r===void 0?void 0:r.uid)||s.multiFactorUid;return y(a,n,"missing-multi-factor-info"),(await zv(n,{mfaPendingCredential:o.credential,mfaEnrollmentId:a,phoneSignInInfo:{recaptchaToken:i}})).phoneResponseInfo.sessionInfo}}else{const{sessionInfo:o}=await jI(n,{phoneNumber:s.phoneNumber,recaptchaToken:i});return o}}finally{t._reset()}}async function uE(n,e){await Yc(S(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sa="webStorageSupport";class tw{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Pn,this._completeRedirectFn=Vo,this._overrideRedirectResult=ou}async _openPopup(e,t,r,i){var s;Ye((s=this.eventManagers[e._key()])===null||s===void 0?void 0:s.manager,"_initialize() not called before _openPopup()");const o=await Qa(e,t,r,Ei(),i);return QE(e,o,Yi())}async _openRedirect(e,t,r,i){await this._originValidation(e);const s=await Qa(e,t,r,Ei(),i);return Mv(s),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:i,promise:s}=this.eventManagers[t];return i?Promise.resolve(i):(Ye(s,"If manager is not set, promise should be"),s)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await GE(e),r=new Uf(e);return t.register("authEvent",i=>(y(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:r.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Sa,{type:Sa},i=>{var s;const o=(s=i==null?void 0:i[0])===null||s===void 0?void 0:s[Sa];o!==void 0&&t(!!o),Re(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=VE(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return lf()||Hc()||Cr()}}const nw=tw;class rw{constructor(e){this.factorId=e}_process(e,t,r){switch(t.type){case"enroll":return this._finalizeEnroll(e,t.credential,r);case"signin":return this._finalizeSignIn(e,t.credential);default:return it("unexpected MultiFactorSessionType")}}}class au extends rw{constructor(e){super("phone"),this.credential=e}static _fromCredential(e){return new au(e)}_finalizeEnroll(e,t,r){return Sv(e,{idToken:t,displayName:r,phoneVerificationInfo:this.credential._makeVerificationRequest()})}_finalizeSignIn(e,t){return Kv(e,{mfaPendingCredential:t,phoneVerificationInfo:this.credential._makeVerificationRequest()})}}class $f{constructor(){}static assertion(e){return au._fromCredential(e)}}$f.FACTOR_ID="phone";var rh="@firebase/auth",ih="1.1.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bw=y;class Mt{constructor(){this.browserResolver=Ge(nw),this.cordovaResolver=Ge(bw),this.underlyingResolver=null,this._redirectPersistence=Pn,this._completeRedirectFn=Vo,this._overrideRedirectResult=ou}async _initialize(e){return await this.selectUnderlyingResolver(),this.assertedUnderlyingResolver._initialize(e)}async _openPopup(e,t,r,i){return await this.selectUnderlyingResolver(),this.assertedUnderlyingResolver._openPopup(e,t,r,i)}async _openRedirect(e,t,r,i){return await this.selectUnderlyingResolver(),this.assertedUnderlyingResolver._openRedirect(e,t,r,i)}_isIframeWebStorageSupported(e,t){this.assertedUnderlyingResolver._isIframeWebStorageSupported(e,t)}_originValidation(e){return this.assertedUnderlyingResolver._originValidation(e)}get _shouldInitProactively(){return zf()||this.browserResolver._shouldInitProactively}get assertedUnderlyingResolver(){return Bw(this.underlyingResolver,"internal-error"),this.underlyingResolver}async selectUnderlyingResolver(){if(this.underlyingResolver)return;const e=await Mw();this.underlyingResolver=e?this.cordovaResolver:this.browserResolver}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zr=y;class ec{constructor(e,t){if(this.app=e,t.isInitialized()){this._delegate=t.getImmediate(),this.linkUnderlyingAuth();return}const{apiKey:r}=e.options;zr(r,"invalid-api-key",{appName:e.name}),zr(r,"invalid-api-key",{appName:e.name});const i=typeof window<"u"?Mt:void 0;this._delegate=t.initialize({options:{persistence:zw(r,e.name),popupRedirectResolver:i}}),this._delegate._updateErrorMap(iI),this.linkUnderlyingAuth()}get emulatorConfig(){return this._delegate.emulatorConfig}get currentUser(){return this._delegate.currentUser?No.getOrCreate(this._delegate.currentUser):null}get languageCode(){return this._delegate.languageCode}set languageCode(e){this._delegate.languageCode=e}get settings(){return this._delegate.settings}get tenantId(){return this._delegate.tenantId}set tenantId(e){this._delegate.tenantId=e}useDeviceLanguage(){this._delegate.useDeviceLanguage()}signOut(){return this._delegate.signOut()}useEmulator(e,t){OI(this._delegate,e,t)}applyActionCode(e){return sv(this._delegate,e)}checkActionCode(e){return Rf(this._delegate,e)}confirmPasswordReset(e,t){return iv(this._delegate,e,t)}async createUserWithEmailAndPassword(e,t){return Me(this._delegate,av(this._delegate,e,t))}fetchProvidersForEmail(e){return this.fetchSignInMethodsForEmail(e)}fetchSignInMethodsForEmail(e){return fv(this._delegate,e)}isSignInWithEmailLink(e){return lv(this._delegate,e)}async getRedirectResult(){zr(Ca(),this._delegate,"operation-not-supported-in-this-environment");const e=await PE(this._delegate,Mt);return e?Me(this._delegate,Promise.resolve(e)):{credential:null,user:null}}addFrameworkForLogging(e){Pw(this._delegate,e)}onAuthStateChanged(e,t,r){const{next:i,error:s,complete:o}=ah(e,t,r);return this._delegate.onAuthStateChanged(i,s,o)}onIdTokenChanged(e,t,r){const{next:i,error:s,complete:o}=ah(e,t,r);return this._delegate.onIdTokenChanged(i,s,o)}sendSignInLinkToEmail(e,t){return uv(this._delegate,e,t)}sendPasswordResetEmail(e,t){return rv(this._delegate,e,t||void 0)}async setPersistence(e){Fw(this._delegate,e);let t;switch(e){case $e.SESSION:t=Pn;break;case $e.LOCAL:t=await Ge(Ri)._isAvailable()?Ri:tu;break;case $e.NONE:t=dr;break;default:return Re("argument-error",{appName:this._delegate.name})}return this._delegate.setPersistence(t)}signInAndRetrieveDataWithCredential(e){return this.signInWithCredential(e)}signInAnonymously(){return Me(this._delegate,ZI(this._delegate))}signInWithCredential(e){return Me(this._delegate,So(this._delegate,e))}signInWithCustomToken(e){return Me(this._delegate,nv(this._delegate,e))}signInWithEmailAndPassword(e,t){return Me(this._delegate,cv(this._delegate,e,t))}signInWithEmailLink(e,t){return Me(this._delegate,hv(this._delegate,e,t))}signInWithPhoneNumber(e,t){return Za(this._delegate,oE(this._delegate,e,t))}async signInWithPopup(e){return zr(Ca(),this._delegate,"operation-not-supported-in-this-environment"),Me(this._delegate,mE(this._delegate,e,Mt))}async signInWithRedirect(e){return zr(Ca(),this._delegate,"operation-not-supported-in-this-environment"),await Xa(this._delegate),EE(this._delegate,e,Mt)}updateCurrentUser(e){return this._delegate.updateCurrentUser(e)}verifyPasswordResetCode(e){return ov(this._delegate,e)}unwrap(){return this._delegate}_delete(){return this._delegate._delete()}linkUnderlyingAuth(){this._delegate.wrapped=()=>this}}ec.Persistence=$e;function ah(n,e,t){let r=n;typeof n!="function"&&({next:r,error:e,complete:t}=n);const i=r;return{next:o=>i(o&&No.getOrCreate(o)),error:e,complete:t}}function zw(n,e){const t=Uw(n,e);if(typeof self<"u"&&!t.includes(Ri)&&t.push(Ri),typeof window<"u")for(const r of[tu,Pn])t.includes(r)||t.push(r);return t.includes(dr)||t.push(dr),t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xo{constructor(){this._=void 0}}function tR(n,e,t){return n instanceof yr?function(i,s){const o={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:i.seconds,nanos:i.nanoseconds}}}};return s&&Yo(s)&&(s=Ou(s)),s&&(o.fields.__previous_value__=s),{mapValue:o}}(t,e):n instanceof Nn?Np(n,e):n instanceof xn?xp(n,e):function(i,s){const o=Vp(i,s),a=Fh(o)+Fh(i.Te);return _c(o)&&_c(i.Te)?kp(a):Cp(i.serializer,a)}(n,e)}function nR(n,e,t){return n instanceof Nn?Np(n,e):n instanceof xn?xp(n,e):t}function Vp(n,e){return n instanceof Ir?function(r){return _c(r)||function(s){return!!s&&"doubleValue"in s}(r)}(e)?e:{integerValue:0}:null}class yr extends Xo{}class Nn extends Xo{constructor(e){super(),this.elements=e}}function Np(n,e){const t=Op(e);for(const r of n.elements)t.some(i=>ft(i,r))||t.push(r);return{arrayValue:{values:t}}}class xn extends Xo{constructor(e){super(),this.elements=e}}function xp(n,e){let t=Op(e);for(const r of n.elements)t=t.filter(i=>!ft(i,r));return{arrayValue:{values:t}}}class Ir extends Xo{constructor(e,t){super(),this.serializer=e,this.Te=t}}function Fh(n){return Z(n.integerValue||n.doubleValue)}function Op(n){return Fi(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ea{constructor(e,t){this.serializer=e,this.userId=t}static lt(e,t){const r=t.uid||"";return new ea(e,r)}getOverlay(e,t){return Hr(e).get(Qh(this.userId,t)).next(r=>r?Fa(this.serializer,r):null)}getOverlays(e,t){const r=ct();return m.forEach(t,i=>this.getOverlay(e,i).next(s=>{s!==null&&r.set(i,s)})).next(()=>r)}saveOverlays(e,t,r){const i=[];return r.forEach((s,o)=>{const a=new Gu(t,o);i.push(this.ht(e,a))}),m.waitFor(i)}removeOverlaysForBatchId(e,t,r){const i=new Set;t.forEach(o=>i.add(xe(o.getCollectionPath())));const s=[];return i.forEach(o=>{const a=IDBKeyRange.bound([this.userId,o,r],[this.userId,o,r+1],!1,!0);s.push(Hr(e).J("collectionPathOverlayIndex",a))}),m.waitFor(s)}getOverlaysForCollection(e,t,r){const i=ct(),s=xe(t),o=IDBKeyRange.bound([this.userId,s,r],[this.userId,s,Number.POSITIVE_INFINITY],!0);return Hr(e).G("collectionPathOverlayIndex",o).next(a=>{for(const c of a){const u=Fa(this.serializer,c);i.set(u.getKey(),u)}return i})}getOverlaysForCollectionGroup(e,t,r,i){const s=ct();let o;const a=IDBKeyRange.bound([this.userId,t,r],[this.userId,t,Number.POSITIVE_INFINITY],!0);return Hr(e).Z({index:"collectionGroupOverlayIndex",range:a},(c,u,l)=>{const h=Fa(this.serializer,u);s.size()<i||h.largestBatchId===o?(s.set(h.getKey(),h),o=h.largestBatchId):l.done()}).next(()=>s)}ht(e,t){return Hr(e).put(function(i,s,o){const[a,c,u]=Qh(s,o.mutation.key);return{userId:s,collectionPath:c,documentId:u,collectionGroup:o.mutation.key.getCollectionGroup(),largestBatchId:o.largestBatchId,overlayMutation:qi(i.ct,o.mutation)}}(this.serializer,this.userId,t))}}function Hr(n){return _e(n,"documentOverlays")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ig(n,e,t){const r=n.store("mutations"),i=n.store("documentMutations"),s=[],o=IDBKeyRange.only(t.batchId);let a=0;const c=r.Z({range:o},(l,h,d)=>(a++,d.delete()));s.push(c.next(()=>{P(a===1)}));const u=[];for(const l of t.mutations){const h=ap(e,l.key.path,t.batchId);s.push(i.delete(h)),u.push(l.key)}return m.waitFor(s).next(()=>u)}function po(n){if(!n)return 0;let e;if(n.document)e=n.document;else if(n.unknownDocument)e=n.unknownDocument;else{if(!n.noDocument)throw R();e=n.noDocument}return JSON.stringify(e).length}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hg{constructor(){this.Qi=!1}initialize(e,t){this.Ki=e,this.indexManager=t,this.Qi=!0}getDocumentsMatchingQuery(e,t,r,i){return this.$i(e,t).next(s=>s||this.Ui(e,t,i,r)).next(s=>s||this.Wi(e,t))}$i(e,t){if(Lh(t))return m.resolve(null);let r=qe(t);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(t.limit!==null&&i===1&&(t=ho(t,null,"F"),r=qe(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=N(...s);return this.Ki.getDocuments(e,o).next(a=>this.indexManager.getMinOffset(e,r).next(c=>{const u=this.Gi(t,a);return this.zi(t,u,o,c.readTime)?this.$i(e,ho(t,null,"F")):this.ji(e,u,t,c)}))})))}Ui(e,t,r,i){return Lh(t)||i.isEqual(b.min())?this.Wi(e,t):this.Ki.getDocuments(e,r).next(s=>{const o=this.Gi(t,s);return this.zi(t,o,r,i)?this.Wi(e,t):(fc()<=L.DEBUG&&_("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),wc(t)),this.ji(e,o,t,np(i,-1)))})}Gi(e,t){let r=new H(Rp(e));return t.forEach((i,s)=>{ls(e,s)&&(r=r.add(s))}),r}zi(e,t,r,i){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const s=e.limitType==="F"?t.last():t.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Wi(e,t){return fc()<=L.DEBUG&&_("QueryEngine","Using full collection scan to execute query:",wc(t)),this.Ki.getDocumentsMatchingQuery(e,t,ze.min())}ji(e,t,r,i){return this.Ki.getDocumentsMatchingQuery(e,r,i).next(s=>(t.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ns=null;function $a(){return Ns===null?Ns=function(){return 268435456+Math.round(2147483648*Math.random())}():Ns++,"0x"+Ns.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pa(n,e,t){let r;return r=n?t&&(t.merge||t.mergeFields)?n.toFirestore(e,t):n.toFirestore(e):e,r}class OP extends Cl{constructor(e){super(),this.firestore=e}convertBytes(e){return new mt(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new J(this.firestore,null,t)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uS(n){cS(n,(e,t)=>new h_(e,t,new iS)),n.registerVersion(tS,nS)}uS(Ne);const lS={apiKey:"AIzaSyD3y-57uze139gYvq8uagnKt9F7IY34jUM",authDomain:"exercise-log-8a9b4.firebaseapp.com",projectId:"exercise-log-8a9b4",storageBucket:"exercise-log-8a9b4.appspot.com",messagingSenderId:"323872244593",appId:"1:323872244593:web:8faa7dbb2c60dab7132cd0"};class wo{constructor(e,t=null,r=!1,i=!1){this.name=e,this.timestamp=t||this.generateRandomTimestamp(),this.paused=r,this.up=i}generateRandomTimestamp(){const e=new Date().getTime(),t=e-7*24*60*60*1e3;return new Date(t+Math.random()*(e-t))}updateTimestamp(){this.timestamp=new Date}}Ne.apps.length?Ne.app():Ne.initializeApp(lS);const g_=Ne.firestore();let ue=[];const hS=()=>{const n=document.getElementById("top-bar");(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1")&&(n.style.display="block")};hS();const dS=document.getElementById("register-form");dS.addEventListener("submit",n=>{n.preventDefault();const e=document.getElementById("register-email"),t=document.getElementById("register-password"),r=e.value,i=t.value;Ne.auth().createUserWithEmailAndPassword(r,i).then(s=>{s.user,alert("User registered successfully.")}).catch(s=>{s.code;var o=s.message;alert(o)})});const fS=document.getElementById("login-form");fS.addEventListener("submit",n=>{n.preventDefault();const e=document.getElementById("login-email"),t=document.getElementById("login-password"),r=e.value,i=t.value;Ne.auth().signInWithEmailAndPassword(r,i).then(s=>{s.user,alert("User logged in successfully.");const o=document.getElementById("auth");o.style.display="none"}).catch(s=>{s.code;var o=s.message;alert(o)})});const mS=document.getElementById("logout-link");mS.addEventListener("click",n=>{n.preventDefault(),Ne.auth().signOut().then(()=>{alert("User signed out successfully.");const e=document.getElementById("dashboard");e.style.display="none"}).catch(e=>{e.code;var t=e.message;alert(t)})});Ne.auth().onAuthStateChanged(n=>{const e=document.getElementById("logged-in-status");if(n){e.textContent=`${n.email} is signed in`;const t=document.getElementById("dashboard");t.style.display="block",pS()}else{e.textContent="No user is signed in";const t=document.getElementById("auth");t.style.display="block"}});const pS=()=>{let n=Ne.auth().currentUser;if(n){let e=n.uid;g_.collection("users").doc(e).collection("exercises").doc("exerciseData").get().then(t=>{if(t.exists){console.log("Exercises document data:",t.data());let r=t.data(),i=[];for(let s in r)i.push(r[s]);ue=i.map(s=>new wo(s.name,new Date(s.timestamp),s.paused,s.up)),Tt(),kd()}else console.log("No exercises document!"),ue.length||(ue=["exercise 1","exercise 2","exercise 3"].map(r=>new wo(r))),Tt(),kd()}).catch(t=>{console.log("Error getting exercises document:",t)})}else console.log("No user is signed in.")},kd=()=>{const n=document.querySelector("#last-updated"),e=localStorage.getItem("last-updated");e&&(n.textContent=e)},Wn=()=>{const e=_S(new Date);document.querySelector("#last-updated").textContent=e,localStorage.setItem("last-updated",e)},Tt=()=>{const n=document.getElementById("exercise-list"),e=document.getElementById("paused-exercise-list"),t=document.getElementById("today-exercise-plan-list");n.innerHTML="",e.innerHTML="",t.innerHTML="",ue.sort((s,o)=>s.timestamp-o.timestamp).forEach((s,o)=>{const c=document.getElementById("exercise-template").content.cloneNode(!0),u=c.querySelector("li");u.id=`li-${o}`;const l=c.querySelector(".name");l.id=`name-${o}`,l.value=s.name,l.addEventListener("click",()=>Dd(o));const h=s.timestamp.toLocaleDateString("en-US",{year:"numeric",month:"2-digit",day:"2-digit"}),d=c.querySelector(".timestamp");d.id=`timestamp-${o}`,d.value=h,d.addEventListener("click",()=>Dd(o)),c.querySelector(".up").onclick=()=>moveUp(s.name),c.querySelector(".done").onclick=()=>markAsDone(s.name);const f=c.querySelector(".pause");f.onclick=()=>togglePause(s.name),c.querySelector(".delete").onclick=()=>deleteExercise(o),s.paused?(u.classList.add("paused"),e.appendChild(c)):s.up?t.appendChild(c):n.appendChild(c)}),document.querySelectorAll(".loading").forEach(s=>{s.style.display="none"})};window.moveUp=n=>{const e=ue.find(t=>t.name===n);e&&(e.up=!e.up,localStorage.setItem("exercises",JSON.stringify(ue)),Tt()),Wn(),Hn()};window.markAsDone=n=>{const e=ue.find(t=>t.name===n);e&&(e.updateTimestamp(),e.up=!1,localStorage.setItem("exercises",JSON.stringify(ue)),Tt()),Wn(),Hn()};window.togglePause=n=>{const e=ue.find(t=>t.name===n);e&&(e.paused=!e.paused,localStorage.setItem("exercises",JSON.stringify(ue)),Tt()),Wn(),Hn()};const Dd=n=>{document.getElementById(`name-${n}`).readOnly=!1,document.getElementById(`timestamp-${n}`).readOnly=!1,document.getElementById(`li-${n}`).classList.add("edit-mode"),document.getElementById(`name-${n}`).addEventListener("keypress",e=>{e.key==="Enter"&&saveExercise(n)}),document.getElementById(`timestamp-${n}`).addEventListener("keypress",e=>{e.key==="Enter"&&saveExercise(n)})};window.saveExercise=n=>{let e=document.getElementById(`name-${n}`).value,t=new Date(document.getElementById(`timestamp-${n}`).value);ue[n].name=e,ue[n].timestamp=t,localStorage.setItem("exercises",JSON.stringify(ue)),Wn(),Tt(),Hn()};window.deleteExercise=n=>{confirm("Are you sure you want to delete this exercise?")&&(ue.splice(n,1),localStorage.setItem("exercises",JSON.stringify(ue)),Tt(),Wn(),Hn())};const gS=document.getElementById("new-exercise-form");gS.addEventListener("submit",n=>{n.preventDefault();const e=document.getElementById("new-exercise-name"),t=e.value.trim();t&&(ue.push(new wo(t)),localStorage.setItem("exercises",JSON.stringify(ue)),e.value="",Tt(),Wn(),Hn())});const _S=n=>{const e={weekday:"short",year:"numeric",month:"long",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat("en-US",e).format(n)},xs=document.getElementById("notification-bar"),Ga=(n,e="success")=>{xs.textContent=n,xs.classList.add(e,"show"),setTimeout(()=>{xs.textContent="",xs.classList.remove(e,"show")},3e3)},Hn=()=>{console.log("Saving exercises to Firestore");let n=Ne.auth().currentUser;if(n){let e=n.uid,t={};JSON.parse(localStorage.getItem("exercises")||"[]").forEach((i,s)=>{t[s]=i}),g_.collection("users").doc(e).collection("exercises").doc("exerciseData").set(t).then(()=>{console.log("Exercises document successfully written!")}).catch(i=>{console.error("Error writing exercises document: ",i)})}else console.log("No user is signed in.")},yS=()=>{navigator.clipboard.readText().then(n=>{try{ue=JSON.parse(n).map(t=>new wo(t.name,new Date(t.timestamp),t.paused,t.up)),localStorage.setItem("exercises",JSON.stringify(ue)),Tt(),Wn(),Hn(),Ga("Exercises imported successfully","success")}catch{Ga("Invalid data in clipboard","error")}}).catch(n=>{Ga("Error reading from clipboard","error")})},IS=document.getElementById("import-button");IS.addEventListener("click",yS);
